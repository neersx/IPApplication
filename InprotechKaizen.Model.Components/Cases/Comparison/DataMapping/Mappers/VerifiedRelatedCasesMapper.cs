...
{
    public class VerifiedRelatedCasesMapper : IComparisonScenarioMapper
    {
        public IEnumerable<Source> ExtractSources(IEnumerable<ComparisonScenario> source)
        {
            var relatedCases = source.OfType<ComparisonScenario<VerifiedRelatedCase>>().ToArray();
        ...
        {
            var relatedCase = scenario as ComparisonScenario<VerifiedRelatedCase>;
        ...
        static void ApplyCountryCodeMapping(ComparisonScenario<VerifiedRelatedCase> relatedCase, IEnumerable<MappedValue> mappedValues)
        {
        ...
        static void ApplyRelationshipCodeMapping(ComparisonScenario<VerifiedRelatedCase> relatedCase, IEnumerable<MappedValue> mappedValues)
        {
