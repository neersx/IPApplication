...
{
    public interface ISubjectSecurityProviderCache : IDisableApplicationCache
    {
        bool IsEmpty { get; }

        void Clear();

        IDictionary<short, SubjectAccess> Resolve(Func<int, IDictionary<short, SubjectAccess>> valuesFactory, int userIdentityId);
    }

    public class SubjectSecurityProviderCache : ISubjectSecurityProviderCache,
                                             ...
                                             IHandle<UserSessionsInvalidatedMessage>
    {
        ...
        static readonly ConcurrentDictionary<int, IDictionary<short, SubjectAccess>> Cache =
            new ConcurrentDictionary<int, IDictionary<short, SubjectAccess>>();
        ...
        public IDictionary<short, SubjectAccess> Resolve(Func<int, IDictionary<short, SubjectAccess>> valuesFactory, int userIdentityId)
        {
            return IsDisabled
