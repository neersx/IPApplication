...
namespace Inprotech.Tests.Integration.IntegrationTests.Configuration.ScreenDesigner.Search
{
    ...
    [TestFixture]
    public class ScreenDesignerSearchBestMatch : IntegrationTest
    {
        ...
        public void ShouldReturnOnlyCorrectPurposeCodeRecords()
        {
            ...
            {
                MatchType = "characteristics-best-match",
        ...
        public void ShouldReturnMultipleMatchesForAllFilters()
        {
            ...
            AssertCriteriaReturnsCount(allCriteriaChecked, 2, "Should return 1 records when all criteria checked");
