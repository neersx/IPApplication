...
{
    public class WipAdjustmentsDbSetup : DbSetup
    {
        const int DebtorBillPercentage40 = 40;

        public dynamic ForWipAdjustments()
        {
            ...
            return Do(x =>
            {
                ...
                var serviceChargeWipType = x.InsertWithNewAlphaNumericId(new WipType {CategoryId = InprotechKaizen.Model.Accounting.WipCategory.ServiceCharge});
