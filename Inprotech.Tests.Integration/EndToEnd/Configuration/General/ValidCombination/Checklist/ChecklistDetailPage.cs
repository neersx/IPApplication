...
namespace Inprotech.Tests.Integration.EndToEnd.Configuration.General.ValidCombination.Checklist
{
    ...
    public class DefaultsTopic : Topic
    {
        ...
        {
            driver.FindElement(By.Id("checklist_selectpage")).WithJs().Click();
        }

        public void ClickOnDelete(NgWebDriver driver)
        {
            driver.FindElement(By.Id("bulkaction_checklist_delete")).WithJs().Click();
        }

        public void ClickOnEdit(NgWebDriver driver)
        {
            driver.FindElement(By.Id("bulkaction_checklist_edit")).WithJs().Click();
        }

        public void ClickOnDuplicate(NgWebDriver driver)
        {
            driver.FindElement(By.Id("bulkaction_checklist_duplicate")).WithJs().Click();
        }
    }
}
