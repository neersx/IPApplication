...
import { TopicData } from 'search/multistepsearch/ipx-step.model';
import { SearchOperator } from '../common/search-operators';

@Injectable()
export class CaseTopicsDataService {
  getTopicsDefaultModel = (): Array<TopicData> => {
    const viewModel: Array<TopicData> = [
      {
        topicKey: 'Details',
        formData: {
          id: '1',
      ...
      },
      {
        ...
        formData: {
          ...
          letters: false,
          charges: false,
          entitySizeOperator: SearchOperator.equalTo
        }
      },
      {
