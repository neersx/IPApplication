namespace inprotech.configuration.general.names.locality {
    class LocalityServiceMock implements ILocalityService {
    ...
    angular.module('inprotech.mocks.configuration.general.names.locality')
        .service('LocalityServiceMock', LocalityServiceMock);
}
