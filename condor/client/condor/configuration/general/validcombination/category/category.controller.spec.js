describe('inprotech.configuration.general.validcombination.category', function() {
    'use strict';
    ...
    beforeEach(inject(function($rootScope, $controller) {
        ...
        controller = function(dependencies) {
            ...
            return $controller('ValidCategoryController', dependencies);
        };
    }));
    ...
    describe('initialisation', function() {
        it('should initialise controller', function() {
            ...
            expect(c.context).toEqual('category');
