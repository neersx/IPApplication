describe('inprotech.configuration.general.validcombination.checklist', function() {
    'use strict';
    ...
    beforeEach(inject(function($rootScope, $controller) {
        ...
        controller = function(dependencies) {
            ...
            return $controller('ValidChecklistController', dependencies);           
        };
    }));
    ...
    describe('initialisation', function() {
        it('should initialise controller', function() {
            ...
            expect(c.context).toEqual('checklist');
