...
namespace Inprotech.Tests
{
    public static class Fixture
    {
        ...
        public static T Object<T>() where T : new()
        {
            ...
            DataFiller.Fill(retval);

            return retval;
        }

        /// <summary>
        ///     Returns the specified value wrapped in another object so that it looks like
        ///     a response from a legacy Inprotech Data Service.
        /// </summary>
        public static Task<JObject> AsDataServiceValueAsync(this object value)
        {
            return Task.FromResult(value.AsDataServiceValue());
        }

        public static JObject AsDataServiceValue(this object value)
        {
