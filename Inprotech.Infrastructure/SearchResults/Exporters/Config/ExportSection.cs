...
namespace Inprotech.Infrastructure.SearchResults.Exporters.Config
{
    public class ExportConfig
    {
        /* keep this file same as CopyExportConfig.cs in Inprotech.Setup.Actions */
        ...
        public class PdfConfig : Config
        {
            ...
            public byte[] IconCheckboxCheckedImage { get; set; }
            public string IconCheckboxUnchecked { get; set; }
            public byte[] IconCheckboxUncheckedImage { get; set; }
            public ReSizeMode ImageReSizeMode { get; set; }
