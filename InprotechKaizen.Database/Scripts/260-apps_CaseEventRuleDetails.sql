...
-----------------------------------------------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id(N'[dbo].[apps_CaseEventRuleDetails]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
begin
	print '**** Drop procedure dbo.apps_CaseEventRuleDetails.'
	drop procedure dbo.apps_CaseEventRuleDetails
end
print '**** Creating procedure dbo.apps_CaseEventRuleDetails...'
print ''
go
...
CREATE procedure [dbo].[apps_CaseEventRuleDetails]	
...
as
---PROCEDURE :	apps_CaseEventRuleDetails
-- VERSION :	2
...
-- ====         ===	=== 		=======	=====================================================================
-- 07 Apr 2020	MS	DR-37170	1		Procedure created (copied from [cs_CaseEventRuleDetails] and modified for apps)
-- 20 Apr 2020	MS	DR-38495	2		Added PayeFees2 and ChargesDesc2 columms from EventControl
...
Begin
	...
	Select	C.IRN,
		...
		CE.LOGAPPLICATION,
		"+dbo.fn_SqlTranslatedColumn('CHARGETYPE','CHARGEDESC',null,'CT2',@sLookupCulture,default)+" as CHARGEDESC2,
		EC.PAYFEECODE2
	...
	left join CHARGETYPE CT2 on (CT2.CHARGETYPENO=EC.INITIALFEE2)
...
grant execute on dbo.apps_CaseEventRuleDetails  to public
go
