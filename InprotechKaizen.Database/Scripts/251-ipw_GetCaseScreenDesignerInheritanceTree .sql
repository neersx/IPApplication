-----------------------------------------------------------------------------------------------------------------------------
-- Creation of ipw_GetCaseScreenDesignerInheritanceTree
-----------------------------------------------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id(N'[dbo].[ipw_GetCaseScreenDesignerInheritanceTree]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
begin
	print '**** Drop procedure dbo.ipw_GetCaseScreenDesignerInheritanceTree.'
	drop procedure dbo.ipw_GetCaseScreenDesignerInheritanceTree
	print '**** Creating procedure dbo.ipw_GetCaseScreenDesignerInheritanceTree...'
	print ''
end
go
...
CREATE PROCEDURE dbo.ipw_GetCaseScreenDesignerInheritanceTree
(
	@psCulture	nvarchar(10) = null,
	@psCriteriaIds	nvarchar(max)
)
-- PROCEDURE :	ipw_GetCaseScreenDesignerInheritanceTree
-- VERSION :	1
...
-- ------------	------	-------	-------	------------------------------------
-- 23/12/2019	SB	DR-52836	1	Procedure created.
...
grant execute on dbo.ipw_GetCaseScreenDesignerInheritanceTree  to public
go
