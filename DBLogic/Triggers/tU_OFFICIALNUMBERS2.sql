	/**********************************************************************************************************/
	/*** Creation of trigger tU_OFFICIALNUMBERS2 								***/
	/**********************************************************************************************************/     
	if exists (select * from sysobjects where type='TR' and name = 'tU_OFFICIALNUMBERS2')
    	begin
     		PRINT 'Refreshing trigger tU_OFFICIALNUMBERS2...'
     		DROP TRIGGER tU_OFFICIALNUMBERS2
    	end
 	go

	CREATE TRIGGER tU_OFFICIALNUMBERS2 on OFFICIALNUMBERS for UPDATE NOT FOR REPLICATION as
	-- TRIGGER :	tU_OFFICIALNUMBERS2
	-- VERSION :	2
