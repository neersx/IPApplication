-----------------------------------------------------------------------------------------------------------------------------
-- Creation of ip_cc_DETAILLETTERS
-----------------------------------------------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id(N'[dbo].[ip_cc_DETAILLETTERS]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
begin
	print '**** Drop procedure dbo.ip_cc_DETAILLETTERS.'
	drop procedure dbo.ip_cc_DETAILLETTERS
	print '**** Creating procedure dbo.ip_cc_DETAILLETTERS...'
	print ''
end
go
...
CREATE PROCEDURE dbo.ip_cc_DETAILLETTERS
...
-- Prerequisite that the CCImport_DETAILLETTERS table has been loaded
...
Begin
	...
	If  @ErrorCode=0
	Begin
		Set @sSQLString="SELECT * from dbo.fn_cc_DETAILLETTERS('"+@psUserName+"')
...
/**************** Data Update ***************************************/
	...
	Begin
		...
		join	CCImport_DETAILLETTERS I	on ( I.CRITERIANO=C.CRITERIANO
...
RETURN @ErrorCode
go
grant execute on dbo.ip_cc_DETAILLETTERS  to public
go
