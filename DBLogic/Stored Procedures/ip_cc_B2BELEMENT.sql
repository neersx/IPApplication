-----------------------------------------------------------------------------------------------------------------------------
-- Creation of ip_cc_B2BELEMENT
-----------------------------------------------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id(N'[dbo].[ip_cc_B2BELEMENT]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
begin
	print '**** Drop procedure dbo.ip_cc_B2BELEMENT.'
	drop procedure dbo.ip_cc_B2BELEMENT
	print '**** Creating procedure dbo.ip_cc_B2BELEMENT...'
	print ''
end
go
...
CREATE PROCEDURE dbo.ip_cc_B2BELEMENT
...
-- PROCEDURE :	ip_cc_B2BELEMENT
-- VERSION :	1
-- DESCRIPTION:	The comparison/display and merging of imported data for the B2BELEMENT table
-- CALLED BY :	
...
-- Prerequisite that the CCImport_B2BELEMENT table has been loaded
...
Begin
	...
	If  @ErrorCode=0
	Begin
		Set @sSQLString="SELECT * from dbo.fn_cc_B2BELEMENT('"+@psUserName+"')
...
/**************** Data Update ***************************************/
	...
	Begin
		...
		from	B2BELEMENT C
		join	CCImport_B2BELEMENT I	on ( I.ELEMENTID=C.ELEMENTID)
" Set @sSQLString1="
...
RETURN @ErrorCode
go
grant execute on dbo.ip_cc_B2BELEMENT  to public
go
