-----------------------------------------------------------------------------------------------------------------------------
-- Creation of ipw_DeleteActivityAttachment
-----------------------------------------------------------------------------------------------------------------------------
If exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ipw_DeleteActivityAttachment]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
Begin
	Print '**** Drop Stored Procedure dbo.ipw_DeleteActivityAttachment.'
	Drop procedure [dbo].[ipw_DeleteActivityAttachment]
End
Print '**** Creating Stored Procedure dbo.ipw_DeleteActivityAttachment...'
Print ''
GO
...
CREATE PROCEDURE dbo.ipw_DeleteActivityAttachment
(
...
as
-- PROCEDURE:	ipw_DeleteActivityAttachment
-- VERSION:	1
...
Grant execute on dbo.ipw_DeleteActivityAttachment to public
GO