-----------------------------------------------------------------------------------------------------------------------------
-- Creation of cs_GlobalFamilyChange
-----------------------------------------------------------------------------------------------------------------------------
If exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[cs_GlobalFamilyChange]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
Begin
	Print '**** Drop Stored Procedure dbo.cs_GlobalFamilyChange.'
	Drop procedure [dbo].[cs_GlobalFamilyChange]
End
Print '**** Creating Stored Procedure dbo.cs_GlobalFamilyChange...'
Print ''
GO
...
CREATE PROCEDURE dbo.cs_GlobalFamilyChange
(
...
as
-- PROCEDURE:	cs_GlobalFamilyChange
-- VERSION:	2
-- COPYRIGHT:	Copyright CPA Global Software Solutions (Australia) Pty Limited
-- DESCRIPTION:	Update the Family field against the specified case. 
--              No concurrency checking.

-- MODIFICATIONS :
-- Date		Who	Change	Version	Description
-- -----------	-------	------	-------	----------------------------------------------- 
-- 15 Oct 2010	LP	RFC9321	1	Procedure created
...
Grant execute on dbo.cs_GlobalFamilyChange to public
GO
