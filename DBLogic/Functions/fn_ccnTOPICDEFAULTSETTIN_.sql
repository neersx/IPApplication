-----------------------------------------------------------------------------------------------------------------------------
-- Creation of fn_ccnTOPICDEFAULTSETTIN_
-----------------------------------------------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id(N'[dbo].[fn_ccnTOPICDEFAULTSETTIN_]') and xtype='IF')
begin
	print '**** Drop function dbo.fn_ccnTOPICDEFAULTSETTIN_.'
	drop function dbo.fn_ccnTOPICDEFAULTSETTIN_
	print '**** Creating function dbo.fn_ccnTOPICDEFAULTSETTIN_...'
	print ''
end
go
...
CREATE FUNCTION dbo.fn_ccnTOPICDEFAULTSETTIN_
(
@psUserName			nvarchar(40)	= 'dbo' -- the current user name which will have created the 'CCImport_' tables dbo used as default for security error instead of crash
)
RETURNS TABLE

-- FUNCTION :	fn_ccnTOPICDEFAULTSETTIN_
-- VERSION :	1
...
As 
Return
select	6 as TRIPNO, 'TOPICDEFAULTSETTINGS' as TABLENAME, count(*) as 'MISSING', 0 as 'NEW', 0 as 'CHANGE', 0 as 'MATCH'
...
UNION ALL 
 select	6, 'TOPICDEFAULTSETTINGS', 0, 0, 0, count(*)
from CCImport_TOPICDEFAULTSETTINGS I 
join TOPICDEFAULTSETTINGS C	on( C.DEFAULTSETTINGNO=I.DEFAULTSETTINGNO)
...
and ( I.FILTERNAME =  C.FILTERNAME)
and (replace( I.FILTERVALUE,char(10),char(13)+char(10)) =  C.FILTERVALUE)
and ( I.ISINHERITED =  C.ISINHERITED OR (I.ISINHERITED is null and C.ISINHERITED is null))
...
go
grant DELETE, INSERT, REFERENCES, SELECT, UPDATE on dbo.fn_ccnTOPICDEFAULTSETTIN_  to public
go
