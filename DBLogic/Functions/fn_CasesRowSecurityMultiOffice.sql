-----------------------------------------------------------------------------------------------------------------------------
-- Creation of fn_CasesRowSecurityMultiOffice
-----------------------------------------------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id('dbo.fn_CasesRowSecurityMultiOffice') and xtype in ('IF','TF'))
begin
	print '**** Drop function dbo.fn_CasesRowSecurityMultiOffice.'
	drop function dbo.fn_CasesRowSecurityMultiOffice
end
print '**** Creating function dbo.fn_CasesRowSecurityMultiOffice...'
print ''
go
