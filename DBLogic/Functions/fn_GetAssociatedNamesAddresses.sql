-----------------------------------------------------------------------------------------------------------------------------
-- Creation of fn_GetAssociatedNamesAddresses
-----------------------------------------------------------------------------------------------------------------------------
if exists (select * from sysobjects where id = object_id('dbo.fn_GetAssociatedNamesAddresses') and xtype='FN')
begin
	print '**** Drop function dbo.fn_GetAssociatedNamesAddresses.'
	drop function dbo.fn_GetAssociatedNamesAddresses
	print '**** Creating function dbo.fn_GetAssociatedNamesAddresses...'
	print ''
end
go
...
CREATE FUNCTION dbo.fn_GetAssociatedNamesAddresses
	(
		@pnNameKey		int,
...
-- FUNCTION :	fn_GetAssociatedNamesAddresses
-- VERSION :	4
-- DESCRIPTION:	This function accepts NameKey, gets the formatted names and addresses and concatenates 
--		them with the Separator between each name and address as the following:
--		<Name><CarriageReturn><Address><CarriageReturn><Name><CarriageReturn><Address>

-- Date		Who	Number	Version	Description
-- ====         ===	======	=======	===========
-- 02 May 2005	TM 	RFC2554	1	Function created
-- 02 May 2005	TM	RFC2554	2	Rename function fn_GetCopyToForName to be fn_GetAssociatedNamesAddresses.
...
Begin
	...
	and   AN.RELATIONSHIP=@psRelationshipKey
	order by AN.SEQUENCE		
	
	Return @sFormattedNameAddressList
End
go

grant execute on dbo.fn_GetAssociatedNamesAddresses to public
GO
