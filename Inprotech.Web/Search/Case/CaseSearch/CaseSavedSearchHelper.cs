...
{
    public static class CaseSavedSearchHelper
    {
        ...
        public static string GetAttributeOperatorValue(this XElement element, string elementName, string attributeName, string defaultValue)
        {
            return element.Element(elementName)?.Attribute(attributeName) != null ?
                Convert.ToInt32(element.Element(elementName)?.Attribute(attributeName)?.Value).ToString() : defaultValue;
        }

        public static string GetAttributeOperatorValue(this XElement element, string elementName, string attributeName)
        {
            return element.Element(elementName)?.Attribute(attributeName) != null ?
                Convert.ToInt32(element.Element(elementName)?.Attribute(attributeName)?.Value).ToString() : Operators.EqualTo;
        }

        public static string GetAttributeOperatorExactValue(this XElement element, string elementName, string attributeName)
        {
            return element.Element(elementName)?.Attribute(attributeName) != null ?
                Convert.ToInt32(element.Element(elementName)?.Attribute(attributeName)?.Value).ToString() : string.Empty;
        }
        ...
        public static string GetAttributeOperatorValueForXPathElement(this XElement element, string xpath, string attributeName, string defaultValue)
        {
            ...
            return xPathElement.Attribute(attributeName) != null ?
                xPathElement.Attribute(attributeName)?.Value : defaultValue;
        }
